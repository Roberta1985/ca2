...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/fesm2015/http.js"); //Import service to get requests to get Service! 
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function getAuthor(author) {
          return this.http.get("https://www.breakingbadapi.com/api/quotes?author=".concat(author));
        }
      }, {
        key: "getDeaths",
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StoreKEY = 'favouriteChars';
    var StoreKEY2 = 'favouriteEp';
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        ...
        key: "isFavourite",
        value: function isFavourite(characterId) {
        ...
        key: "favouriteChar",
        value: function favouriteChar(characterId) {
          var _this = this;

          return this.getAllFavouriteChars().then(function (result) {
            if (result) {
              result.push(characterId);
              return _this.storage.set(StoreKEY, result);
            } else {
              return _this.storage.set(StoreKEY, [characterId]);
            }
          });
        }
      }, {
        key: "unfavouriteChar",
        value: function unfavouriteChar(characterId) {
          var _this2 = this;
          ...
          return this.getAllFavouriteChars().then(function (result) {
            if (result) {
              ...
              return _this2.storage.set(StoreKEY, result);
            }
          });
        } //Episodes 
        ...
        value: function favouriteEp(episodeId) {
          ...
          return this.getAllFavouriteEps().then(function (result) {
            if (result) {
              ...
              return _this3.storage.set(StoreKEY2, result);
            } else {
              return _this3.storage.set(StoreKEY2, [episodeId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteEp(episodeId) {
          ...
          return this.getAllFavouriteEps().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(StoreKEY2, result);
            }
          });
        }
      }]);
