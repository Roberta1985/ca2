...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["episodes-episodes-module"], {
  ...
  function srcAppPagesEpisodesEpisodesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EpisodesPage = /*#__PURE__*/function () {
      function EpisodesPage(api, router) {
      ...
      _createClass(EpisodesPage, [{
        ...
        value: function openDetails(episode) {
          var epId = episode.episode_id;
          this.router.navigateByUrl("/tabs/episodes/".concat(epId));
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], EpisodesPage);
    /***/
  }
}]);
